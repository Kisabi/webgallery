...
/**
 * Сторінка входу в обліковий запис.
 * Відправляє POST /api/auth/login та зберігає JWT через AuthContext.
 */
const LoginPage = () => {
  const { login } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 w-full max-w-sm">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Вхід</h1>
